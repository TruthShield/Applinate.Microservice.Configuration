...
class Build : NukeBuild
{
    ...
    Target Pack => _ => _
      ...
      {
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.Configuration.Abstractions"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
          ...
          DotNetPack(s => s
           .SetProject(Solution.GetProject("Applinate.Microservice.Configuration.Core"))
           .SetConfiguration(Configuration)
           .EnableNoBuild()
           .EnableNoRestore()
           .SetVersion(Version)
          ...
          DotNetPack(s => s
          .SetProject(Solution.GetProject("Applinate.Microservice.Configuration.Emulator"))
          .SetConfiguration(Configuration)
          .EnableNoBuild()
          .EnableNoRestore()
          .SetVersion(Version)
